...
class CustomColumnComboBox(QComboBox):
    ...
    def get_selected_column(self):
        debug_print("CustomColumnComboBox::get_selected_column - self.currentIndex()=", self.currentIndex())
        debug_print("CustomColumnComboBox::get_selected_column - self.column_names=", self.column_names)
